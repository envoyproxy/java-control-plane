 ...
 * abstract away xDS version. XdsRequest is passed around the codebase through common codez
 */
@AutoValue
public abstract class XdsRequest {
   ...
   * for v3 resource types and having a key to normalize on the logical resource.
   */
