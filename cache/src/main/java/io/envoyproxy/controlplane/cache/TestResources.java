...
import io.envoyproxy.envoy.api.v2.Cds.Cluster.DiscoveryType;
import io.envoyproxy.envoy.api.v2.Cds.Cluster.EdsClusterConfig;
...
import io.envoyproxy.envoy.api.v2.auth.Cert.TlsCertificate;
import io.envoyproxy.envoy.api.v2.core.AddressOuterClass.Address;
import io.envoyproxy.envoy.api.v2.core.AddressOuterClass.SocketAddress;
import io.envoyproxy.envoy.api.v2.core.AddressOuterClass.SocketAddress.Protocol;
import io.envoyproxy.envoy.api.v2.core.Base.DataSource;
import io.envoyproxy.envoy.api.v2.core.ConfigSourceOuterClass.AggregatedConfigSource;
import io.envoyproxy.envoy.api.v2.core.ConfigSourceOuterClass.ApiConfigSource;
import io.envoyproxy.envoy.api.v2.core.ConfigSourceOuterClass.ApiConfigSource.ApiType;
import io.envoyproxy.envoy.api.v2.core.ConfigSourceOuterClass.ConfigSource;
import io.envoyproxy.envoy.api.v2.core.GrpcServiceOuterClass.GrpcService;
import io.envoyproxy.envoy.api.v2.core.GrpcServiceOuterClass.GrpcService.EnvoyGrpc;
import io.envoyproxy.envoy.api.v2.endpoint.EndpointOuterClass.Endpoint;
import io.envoyproxy.envoy.api.v2.endpoint.EndpointOuterClass.LbEndpoint;
import io.envoyproxy.envoy.api.v2.endpoint.EndpointOuterClass.LocalityLbEndpoints;
import io.envoyproxy.envoy.api.v2.listener.Listener.Filter;
import io.envoyproxy.envoy.api.v2.listener.Listener.FilterChain;
import io.envoyproxy.envoy.api.v2.route.RouteOuterClass.Route;
import io.envoyproxy.envoy.api.v2.route.RouteOuterClass.RouteAction;
import io.envoyproxy.envoy.api.v2.route.RouteOuterClass.RouteMatch;
import io.envoyproxy.envoy.api.v2.route.RouteOuterClass.VirtualHost;
import io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpConnectionManagerOuterClass.HttpConnectionManager;
import io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpConnectionManagerOuterClass.HttpConnectionManager.CodecType;
import io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpConnectionManagerOuterClass.HttpFilter;
import io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpConnectionManagerOuterClass.Rds;
