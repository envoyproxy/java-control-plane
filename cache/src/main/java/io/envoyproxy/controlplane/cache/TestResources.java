...
public class TestResources {
  ...
  public static Listener createListener(boolean ads,
      io.envoyproxy.envoy.api.v2.core.ApiVersion rdsTransportVersion, String listenerName,
  ...
  public static io.envoyproxy.envoy.config.listener.v3.Listener createListenerV3(boolean ads,
      ApiVersion rdsTransportVersion, String listenerName, int port, String routeName) {
